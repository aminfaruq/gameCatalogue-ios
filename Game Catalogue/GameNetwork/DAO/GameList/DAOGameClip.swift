...
public final class DAOGameClip: NSCoding {
  ...
  public required init(json: JSON) {
    clips = DAOGameClips(json: json[SerializationKeys.clips])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.clips = aDecoder.decodeObject(forKey: SerializationKeys.clips) as? DAOGameClips
