...
public final class DAODeveloperResults: NSCoding {
  ...
  public var games: [DAODeveloperGames]?
  public var id: Int?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.games].array { games = items.map { DAODeveloperGames(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.games = aDecoder.decodeObject(forKey: SerializationKeys.games) as? [DAODeveloperGames]
