//
//  DAODeveloperListBaseClass.swift
//
...
public final class DAODeveloperListBaseClass: NSCoding {
  ...
  public var results: [DAODeveloperResults]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.results].array { results = items.map { DAODeveloperResults(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.results = aDecoder.decodeObject(forKey: SerializationKeys.results) as? [DAODeveloperResults]
