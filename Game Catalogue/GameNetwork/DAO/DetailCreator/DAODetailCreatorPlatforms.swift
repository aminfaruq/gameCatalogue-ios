//
//  DAODetailCreatorPlatforms.swift
//
...
public final class DAODetailCreatorPlatforms: NSCoding {
  ...
  public var results: [DAODetailCreatorResults]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.results].array { results = items.map { DAODetailCreatorResults(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.results = aDecoder.decodeObject(forKey: SerializationKeys.results) as? [DAODetailCreatorResults]
