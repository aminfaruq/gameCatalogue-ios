...
public final class DAODetailCreatorResults: NSCoding {
  ...
  // MARK: Properties
  public var platform: DAODetailCreatorPlatform?
  ...
  public required init(json: JSON) {
    platform = DAODetailCreatorPlatform(json: json[SerializationKeys.platform])
  ...
  required public init(coder aDecoder: NSCoder) {
    self.platform = aDecoder.decodeObject(forKey: SerializationKeys.platform) as? DAODetailCreatorPlatform
